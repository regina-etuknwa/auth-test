...
const NewPassword = () => {
    return ( 
        <div>
            <div className="popup">
                <div className="popup-text">Password changed successfully. Proceed to <Link to="/sign-in">login</Link></div>
            ...
            <form className="form" action="">
                ...
                <div className="input-field">
                    ...
                    <input type="password" id="confirm-new-password" placeholder="Retype Password" />
                </div>
